...
BEGIN
    ...
    SET kr.result_rate = CASE 
        ...
        -- กรณีสูตร "คะแนนเต็ม 50"
        WHEN i.unit = 'คะแนนเต็ม 50' THEN 
            (kr.result_amount / kr.target_amount) * 100
